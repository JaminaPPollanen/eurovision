...
return(
    <View style={styles.container}>
      <View>
        <Text style={styles.title}>Ensimmäisen semifinaalin alkuun:</Text>
        <CountDown
      ...
      <Text style={styles.text}>Euroviisujen ensimmäinen semifinaali pidetään tiistaina 18.05.2021 klo 21 alkaen. Tässä esittelemme ensimmäisen semifinaalin arvotun esiintymisjärjestyksen:</Text>
